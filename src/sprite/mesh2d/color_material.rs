...
use crate::{
    ...
    render::{
        ...
        render_resource::{BindGroup, BindGroupLayout, Buffer, Shader},
...
use super::{Material2d, Material2dPipeline, MaterialMesh2dBundle};
...
impl RenderAsset for ColorMaterial {
    ...
    type Param = (
        ...
        Res<'static, Material2dPipeline<ColorMaterial>>,
