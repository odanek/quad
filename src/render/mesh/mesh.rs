...
impl TypeUuid for Mesh {
    const TYPE_UUID: Uuid = uuid!("8ecbac0f-f545-4473-ad43-e1f4243af51e");
}
...
impl Mesh {
    ...
    pub fn compute_aabb(&self) -> Option<Aabb> {
            ...
            self.attribute(Mesh::ATTRIBUTE_POSITION)
        {
            ...
            for p in values {
                minimum = minimum.min_element_wise(Vec3::from_slice(p));
                maximum = maximum.max_element_wise(Vec3::from_slice(p));
            }
...
impl VertexAttributeValues {
    ...
    pub fn len(&self) -> usize {
        ...
        match *self {
            ...
            Uint32(ref values) => values.len(),
            Float32x2(ref values) => values.len(),
            Sint32x2(ref values) => values.len(),
            Uint32x2(ref values) => values.len(),
            Float32x3(ref values) => values.len(),
            Sint32x3(ref values) => values.len(),
            Uint32x3(ref values) => values.len(),
            Float32x4(ref values) => values.len(),
            Sint32x4(ref values) => values.len(),
            Uint32x4(ref values) => values.len(),
            Sint16x2(ref values) => values.len(),
            Snorm16x2(ref values) => values.len(),
            Uint16x2(ref values) => values.len(),
            Unorm16x2(ref values) => values.len(),
            Sint16x4(ref values) => values.len(),
            Snorm16x4(ref values) => values.len(),
            Uint16x4(ref values) => values.len(),
            Unorm16x4(ref values) => values.len(),
            Sint8x2(ref values) => values.len(),
            Snorm8x2(ref values) => values.len(),
            Uint8x2(ref values) => values.len(),
            Unorm8x2(ref values) => values.len(),
            Sint8x4(ref values) => values.len(),
            Snorm8x4(ref values) => values.len(),
            Uint8x4(ref values) => values.len(),
            Unorm8x4(ref values) => values.len(),
        }
    }
    ...
    pub fn enum_variant_name(&self) -> &'static str {
        ...
        match *self {
            ...
            Sint32(_) => "Sint32",
            Uint32(_) => "Uint32",
            Float32x2(_) => "Float32x2",
            Sint32x2(_) => "Sint32x2",
            Uint32x2(_) => "Uint32x2",
            Float32x3(_) => "Float32x3",
            Sint32x3(_) => "Sint32x3",
            Uint32x3(_) => "Uint32x3",
            Float32x4(_) => "Float32x4",
            Sint32x4(_) => "Sint32x4",
            Uint32x4(_) => "Uint32x4",
            Sint16x2(_) => "Sint16x2",
            Snorm16x2(_) => "Snorm16x2",
            Uint16x2(_) => "Uint16x2",
            Unorm16x2(_) => "Unorm16x2",
            Sint16x4(_) => "Sint16x4",
            Snorm16x4(_) => "Snorm16x4",
            Uint16x4(_) => "Uint16x4",
            Unorm16x4(_) => "Unorm16x4",
            Sint8x2(_) => "Sint8x2",
            Snorm8x2(_) => "Snorm8x2",
            Uint8x2(_) => "Uint8x2",
            Unorm8x2(_) => "Unorm8x2",
