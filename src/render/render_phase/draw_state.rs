...
impl<'a> TrackedRenderPass<'a> {
    ...
    pub fn set_render_pipeline(&mut self, pipeline: &'a RenderPipeline) {
        log::trace!("set pipeline: {:?}", pipeline);
    ...
    pub fn set_index_buffer(
            ...
            .is_index_buffer_set(buffer_slice.id(), offset, index_format)
        {
            ...
            log::trace!("set index buffer: {:?} ({})", buffer_slice.id(), offset);
        }
    ...
    pub fn draw(&mut self, vertices: Range<u32>, instances: Range<u32>) {
        log::trace!("draw: {:?} {:?}", vertices, instances);
    ...
    pub fn set_stencil_reference(&mut self, reference: u32) {
        log::trace!("set stencil reference: {}", reference);
    ...
    pub fn set_scissor_rect(&mut self, x: u32, y: u32, width: u32, height: u32) {
        log::trace!("set_scissor_rect: {} {} {} {}", x, y, width, height);
    ...
    pub fn insert_debug_marker(&mut self, label: &str) {
        log::trace!("insert debug marker: {}", label);
    ...
    pub fn push_debug_group(&mut self, label: &str) {
        log::trace!("push_debug_group marker: {}", label);
    ...
    pub fn pop_debug_group(&mut self) {
        log::trace!("pop_debug_group");
        self.pass.pop_debug_group();
    }

    pub fn set_blend_constant(&mut self, color: Color) {
        log::trace!("set blend constant: {:?}", color);
